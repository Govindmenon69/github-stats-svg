...
This is my github stats svg
      ...
      >
        <title id="titleId">Govind Menon 's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 5, Total Commits  : 5, Total PRs: 3, Total Issues: 2, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 237.29840067499404;
      }
    }
    ...
    @keyframes fadeInAnimation {
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Govind Menon 's GitHub Stats</text>
    </g>
      </g>
